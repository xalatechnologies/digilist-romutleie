...
const INITIAL_BOOKINGS: IBooking[] = [
  ...
  // Arrivals today (startDate = getDate(0))
  { 
    id: 'b9', 
    customerType: CustomerType.COMPANY,
    customerName: 'Anna Nordström', 
    companyName: 'Scandinavian Design AB',
    customerEmail: 'anna@scandesign.se', 
    customerPhone: '+46 8 123 45 67',
    billingAddress: 'Stockholm, Sweden',
    orgNumber: 'SE-123456',
    guestCount: 2, 
    roomId: '4', 
    startDate: getDate(0), 
    endDate: getDate(3), 
    status: BookingStatus.CONFIRMED, 
    checkInTime: `${getDate(0)}T15:00:00`,
    totalPrice: 4350, 
    reference1: 'SD-2025-001',
    bookingMode: 'Individual',
    paymentMethod: PaymentMethod.INVOICE,
    cardGuaranteeRequired: false,
    extraFees: []
  ...
  { 
    ...
    endDate: getDate(2), 
    status: BookingStatus.CONFIRMED, 
    checkInTime: `${getDate(0)}T14:00:00`,
    totalPrice: 1900, 
    bookingMode: 'Individual',
    paymentMethod: PaymentMethod.PREPAYMENT,
    cardGuaranteeRequired: true,
  ...
  { 
    ...
    customerEmail: 'sophie@parisconsulting.fr', 
    ...
    endDate: getDate(5), 
    status: BookingStatus.CONFIRMED, 
    checkInTime: `${getDate(0)}T16:30:00`,
    totalPrice: 11625, 
    reference1: 'PCG-2025-Q1',
    bookingMode: 'Group',
    groupName: 'European Summit 2025',
    paymentMethod: PaymentMethod.INVOICE,
    cardGuaranteeRequired: false,
    extraFees: []
  },
  
  // Departures today (endDate = getDate(0))
  { 
    id: 'b12', 
    customerType: CustomerType.PERSON,
    ...
    billingAddress: 'Chicago, IL',
    guestCount: 2, 
    roomId: '6', 
    startDate: getDate(-3), 
    endDate: getDate(0), 
    status: BookingStatus.CHECKED_IN, 
    checkInTime: `${getDate(-3)}T15:00:00`,
    checkOutTime: `${getDate(0)}T11:00:00`,
    totalPrice: 5700, 
    bookingMode: 'Individual',
    paymentMethod: PaymentMethod.PAYMENT_LINK,
    cardGuaranteeRequired: true,
  ...
  { 
    ...
    companyName: 'Nordic Tech Solutions',
    customerEmail: 'lisa@nordictech.no', 
    customerPhone: '+47 22 33 44 55',
    billingAddress: 'Oslo, Norway',
    orgNumber: 'NO-112233',
    guestCount: 1, 
    roomId: '8', 
    ...
    endDate: getDate(0), 
    status: BookingStatus.CHECKED_IN, 
    checkInTime: `${getDate(-5)}T14:30:00`,
    checkOutTime: `${getDate(0)}T10:00:00`,
    totalPrice: 4750, 
    reference1: 'NTS-2025-001',
    bookingMode: 'Individual',
    paymentMethod: PaymentMethod.INVOICE,
    cardGuaranteeRequired: false,
    extraFees: []
  ...
  { 
    ...
    status: BookingStatus.CHECKED_IN, 
    checkInTime: `${getDate(-2)}T16:00:00`,
    checkOutTime: `${getDate(0)}T11:30:00`,
    totalPrice: 3800, 
    bookingMode: 'Individual',
    paymentMethod: PaymentMethod.PREPAYMENT,
    cardGuaranteeRequired: true,
